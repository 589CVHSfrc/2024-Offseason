...
public class DriveSubsystem extends SubsystemBase {
  ...
  private HolonomicPathFollowerConfig m_driveConfig = new HolonomicPathFollowerConfig(
      new PIDConstants(
        ModuleConstants.kDrivingP, ModuleConstants.kDrivingI,
  ...
  public double getPositionModule(swerveModules module){
    switch(module){
      case FrontRight :
            return //m_frontRight
      ...
      case BackRight :
            return m_backRight.getPosition().distanceMeters;
      case BackLeft :
            return m_backLeft.getPosition().distanceMeters;
    }
    return 0;
  }

  public double getZeroOffsetForRea(turningModules module) {
    switch(module){
      case FrontRightT :
            return m_frontRight.getACTUALturningEncoder().getZeroOffset();
      case FrontLeftT :
            return m_frontLeft.getACTUALturningEncoder().getZeroOffset();
      case BackRightT :
            return m_backRight.getACTUALturningEncoder().getZeroOffset();
      case BackLeftT :
            return m_backLeft.getACTUALturningEncoder().getZeroOffset();
    }
    return 0;
  }

  public double getTurningEncoder(turnModules module) {
    switch(module){
      case FrontRighT :
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
    ...
    if (rateLimit) {
      ...
      directionSlewRate = 0; //Remove MEOW 3: 
  ...
  public void alignWheels() {
    ...
    m_backLeft.setDesiredState(new SwerveModuleState(0.01, Rotation2d.fromDegrees(0)));
    m_backRight.setDesiredState(new SwerveModuleState(0.01, Rotation2d.fromDegrees(0)));
  ...
  // m_backLeft.setDesiredState(new SwerveModuleState(0.00,
  // Rotation2d.fromDegrees(0)));
  // m_backRight.setDesiredState(new SwerveModuleState(0.0,
  // Rotation2d.fromDegrees(0)));
  ...
  public double getEncoderMeters() {
    double distance = (m_frontRight.getPosition().distanceMeters + m_frontLeft.getPosition().distanceMeters)/2;
    return distance;
  }
  ...
  public void stopAllModules() {
    ...
    m_backLeft.setDesiredState(new SwerveModuleState(0,
        m_backLeft.getState().angle));
    m_backRight.setDesiredState(new SwerveModuleState(0,
  ...
  public double[] wheelRPM(){
    return new double[] {m_backLeft.getNeoRPM(),m_backRight.getNeoRPM(),m_frontLeft.getNeoRPM(),m_frontRight.getNeoRPM()};
  }
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumberArray("Drive RPM", wheelRPM());
