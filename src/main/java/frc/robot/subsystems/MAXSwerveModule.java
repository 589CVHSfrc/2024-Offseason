...
public class MAXSwerveModule {
  ...
  private final AbsoluteEncoder m_turningEncoder; //MAKE SURE TO TURN IT BACK TO A PRIVATE FINAL VARIABLE - YUNA >:D
  ...
  public AbsoluteEncoder getACTUALturningEncoder(){
    AbsoluteEncoder turningEncoder = m_turningEncoder;
  ...
  public double getNeoRPM(){
    return m_drivingEncoder.getVelocity()/ModuleConstants.kDrivingEncoderVelocityFactor;
  }
